          ...
          <div className="bg-white rounded-2xl shadow-large p-8 border border-neutral-200 backdrop-blur-sm">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-neutral-600 text-sm">
                Join thousands of data analysts using InsightFlow
              </p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSignup}>
              ...
              {success && (
                <div className="rounded-lg bg-green-50 border-2 border-green-200 p-4 flex items-start gap-3">
            ...
            {/* <div className="mt-8 pt-6 border-t border-neutral-200">
              <p className="text-xs text-neutral-600 font-semibold mb-3 uppercase tracking-wide">Get instant access to:</p>
